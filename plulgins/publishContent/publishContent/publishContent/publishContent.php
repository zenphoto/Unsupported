...
if (db_connect()) {
	if (isset($_POST['set_defaults'])) {
		...
		$gallery->setAlbumPublish((int) isset($_POST['album_default']));
		$gallery->setImagePublish((int) isset($_POST['image_default']));
		$gallery->save();
		$report = 'defaults';
	...
	<?php
	$albpublish = $gallery->getAlbumPublish();
	$imgpublish = $gallery->getImagePublish();
