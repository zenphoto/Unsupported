<?php
/**
 * An example of the 'comment_form_defaults' filter
 */
...
function example_comment_form_defaults($defaults) {
	...
	// disable the anonomous and private checkboxes (could also reset the options, but this is an example after all!)
