...
<form id="mailform" action="<?php echo html_encode(getRequestURI()); ?>" method="post" accept-charset="UTF-8">
    ...
    <table style="border:none">
        ...
        <tr>
            ...
            <td><input type="text" id="title" name="title" size="50" value="<?php echo html_encode($mailcontent['title']); ?>"<?php if ($_processing_post) {
        ...
        <tr>
            ...
            <td><input type="text" id="name" name="name" size="50" value="<?php echo html_encode($mailcontent['name']); ?>"<?php if ($_processing_post) {
                echo ' disabled="disabled"';
                                                                          } ?> />
            </td>
        </tr>
        ...
        <tr id="username" style="display:none;">
            <td>Username:</td>
            <td><input type="text" id="username" name="username" size="50" value="<?php echo html_encode($mailcontent['honeypot']); ?>"<?php if ($_processing_post) {
                echo ' disabled="disabled"';
                                                                                  } ?> />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" id="company" name="company" size="50" value="<?php echo html_encode($mailcontent['company']); ?>"<?php if ($_processing_post) {
                echo ' disabled="disabled"';
                                                                                } ?> />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" id="street" name="street" size="50" value="<?php echo html_encode($mailcontent['street']); ?>"<?php if ($_processing_post) {
                echo ' disabled="disabled"';
                                                                              } ?> />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" id="city" name="city" size="50" value="<?php echo html_encode($mailcontent['city']); ?>"<?php if ($_processing_post) {
                echo ' disabled="disabled"';
                                                                          } ?> />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" id="state" name="state" size="50" value="<?php echo html_encode($mailcontent['city']); ?>"<?php if ($_processing_post) {
                echo ' disabled="disabled"';
                                                                            } ?> />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" id="country" name="country" size="50" value="<?php echo html_encode($mailcontent['country']); ?>"<?php if ($_processing_post) {
                echo ' disabled="disabled"';
                                                                                } ?> />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" id="postal" name="postal" size="50" value="<?php echo html_encode($mailcontent['postal']); ?>"<?php if ($_processing_post) {
                echo ' disabled="disabled"';
                                                                              } ?> />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" id="email" name="email" size="50" value="<?php echo html_encode($mailcontent['email']); ?>"<?php if ($_processing_post) {
                echo ' disabled="disabled"';
                                                                            } ?> />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" id="website" name="website" size="50" value="<?php echo html_encode($mailcontent['website']); ?>"<?php if ($_processing_post) {
                echo ' disabled="disabled"';
                                                                                } ?> />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" id="phone" name="phone" size="50" value="<?php echo html_encode($mailcontent['phone']); ?>"<?php if ($_processing_post) {
                echo ' disabled="disabled"';
                                                                            } ?> /></td>
        </tr>
        <?php
...
<?php } ?>
        ...
        <tr>
            ...
            <td><input type="text" id="subject" name="subject" size="50" value="<?php echo html_encode($mailcontent['subject']); ?>"<?php if ($_processing_post) {
                echo ' disabled="disabled"';
                                                                                } ?> /></td>
        </tr>
        <?php } ?>
        ...
        <tr>
            ...
            <td><textarea id="message" name="message" rows="5" cols="39" <?php if ($_processing_post) {
                echo ' disabled="disabled"';
                                                                         } ?>><?php echo $mailcontent['message']; ?></textarea></td>
        </tr>
        <?php } ?>
