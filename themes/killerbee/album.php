...
<div id="main">
  ...
  <div id="title">
	<h1>
	  <a href="<?php echo getGalleryIndexURL();?>" title="Gallery Index"><?php echo getGalleryTitle();?></a><?php if(getParentBreadcrumb()){printParentBreadcrumb(" | ","","");} ?> | <?php printAlbumTitle(true);?>
	</h1>
