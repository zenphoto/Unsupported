...
<div id="main">
	...
	<div id="gallerytitle">
		<h2>
		<span class="linkit albumtitle"><a href="<?php echo getGalleryIndexURL(false);?>"><?php echo getGalleryTitle();?></a></span>
		</h2>
	</div>
	...
	<div class="imageit newsbody" style="color: #ddd;text-align: justify; text-jutify: newspaper; padding: 40px 60px 40px 60px;">
		<div style="text-align:center; font-size: 15px; color: #666; font-weight: bold;padding: 20px;">
			...
			<p><a href="<?php echo getGalleryIndexURL();?>"><img class="rabbit" src="<?= $_zp_themeroot ?>/images/rabbit-500.png"/></a></p>
