	...
	<div class="wrapper contrast top">
		<div class="container">	
			<div class="sixteen columns">
				...
				<h5><?php printNewsIndexURL(gettext('News')); echo ' » '; ?></h5>
		...
		<div class="container">
			<div class="sixteen columns">
				...
				<ul class="taglist rss">
					<?php if ((function_exists('printCommentForm')) && (getOption('RSS_article_comments'))) { ?><li><?php printZenpageRSSLink('Comments-news','','',gettext('Comments of this article'),'',false); ?></li><?php } ?>
				</ul>
			</div>
		</div>
	</div>
