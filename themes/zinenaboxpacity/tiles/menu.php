<?php 
	if ( getOption('simplicity2_print_home_menu_item') ) {
		MenuUtil::printMenuItem(getGalleryIndexUrl(false), gettext("Home"), THEME_HOME, "first"); 
	}
	MenuUtil::printMenuItem(getGalleryIndexUrl(true), gettext("Gallery"), THEME_GALLERY, '', true); 
